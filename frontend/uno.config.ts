...
export default defineConfig({
  presets: [
    ...
    presetIcons({
      // Pilihan ikon otomatis (lucide, mdi, dll)
      scale: 1.2,
      cdn: "https://esm.sh/",
      warn: true,
    }),
  ...
  shortcuts: {
    "card-panel":
      "bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 rounded-xl p-5 shadow-sm transition-colors",
