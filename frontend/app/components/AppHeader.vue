...
<template>
  <header
    class="flex justify-between items-center border-b border-slate-200 dark:border-slate-700/80 pb-4 mb-6"
  >
    <div>
      <h1
        class="m-0 text-sky-600 dark:text-sky-400 flex items-center gap-2.5 text-2xl font-bold"
      >
        <div
          class="i-lucide-activity text-sky-600 dark:text-sky-400 text-3xl"
        />
    ...
    <div class="flex items-center gap-3">
      ...
      >
        <div
          :class="
            colorMode.value === 'light' ? 'i-lucide-moon' : 'i-lucide-sun'
          "
          class="text-base"
        />
        <span>{{
