...
import { useTelemetryChart, type TelemetryItem } from '~/composables/useTelemetryChart'
...
<template>
  <div>
    <div class="flex justify-between items-center mb-2">
      <h3 class="text-sm font-bold text-slate-700 dark:text-slate-200">Real-time Telemetry Trend</h3>
      <ChartFilterBadges />
    </div>
