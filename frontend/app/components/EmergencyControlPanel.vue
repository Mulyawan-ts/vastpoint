...
<template>
  <section class="card-panel">
    <h2
      class="m-0 text-lg text-slate-800 dark:text-slate-100 mb-4 flex items-center gap-2 font-bold"
    >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div
        class="bg-slate-100 dark:bg-slate-900/60 p-4 rounded-lg border border-slate-200 dark:border-slate-800 flex justify-between items-center"
      >
        <div>
          <div
