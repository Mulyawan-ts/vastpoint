...
const { telemetryQuery, analyticsQuery, alertsQuery, alertHistoryQuery } =
  useIocQueries();
...
<template>
  <div
    class="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-8 transition-colors duration-300"
  >
    <AppHeader />
